    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href=""><i class="bi bi-chat"></i> Brand Spot</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                    ...
                    <button class="btn">Estimate Project</button>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                ...
                                <p class="card-text">Development. Jan 19,2023</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">Travel Website</h4>
                                <p class="card-text">UI/UX Aug 9,2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">SaaS Website</h4>
                                <p class="card-text">Development. Sept 25 ,2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Email Us</h3>
                                <p>brandspot@gmail.com<br>brand@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <p class="logo"><i class="bi bi-chat"></i> Brand Spot</p>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <ul class="d-flex">
